...
public class BallControlAlt : MonoBehaviour
{
    ...
    private PlatformControlAlt currentPlatform;
    ...
    {
        //PLATFORM
        PlatformControlAlt platform = collision.gameObject.GetComponent<PlatformControlAlt>();
        if (platform != null)
        {
            onBridge = false;
            canJump = true;
